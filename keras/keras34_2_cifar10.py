...
# 2. 모델 구성 
# model = Sequential()
# model.add(Conv2D(filters=256, kernel_size=(3, 3), input_shape=(32, 32, 3), activation='relu')) # (27, 27, 128)
# model.add(Conv2D(filters=128, kernel_size=(3, 3)))                             # (26, 26, 64)
# model.add(Conv2D(filters=64, kernel_size=(3, 3)))                             # (25, 25, 64)
# model.add(Flatten())
